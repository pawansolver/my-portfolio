...
export default function CompanyOverviewPage() {
  ...
  return (
    ...
    >
      ...
      {/* --- 1. HERO SECTION --- */}
      {/* 🔥 FIX: Added pt-navbar and px-4 for safe mobile edges */}
      <section className="section pt-navbar relative min-h-[90vh] md:min-h-[85vh] flex items-center justify-center text-white px-4 sm:px-6">
        ...
        <div className="relative z-10 text-center container-custom mt-12 md:mt-0 w-full">
          ...
          >
            ...
            <button onClick={() => openModal("Office Tour")} className="btn-inverse">
              Let's Talk
            </button>
          </motion.div>
        </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div className="order-2 lg:order-1 w-full text-left">
              <h2 className="heading-xl !text-left !mb-4 md:!mb-6">Built on Trust <br />and Innovation</h2>
              ...
              <div className="space-y-6 md:space-y-8">
                {[
                  ...
                  <div key={i} className="flex gap-4 md:gap-5 items-start">
                    <Rocket className="text-brandOrange w-6 h-6 md:w-7 md:h-7 flex-shrink-0 mt-1" />
                    <div>
            ...
            <div className="relative group order-1 lg:order-2 w-full mx-auto md:max-w-md lg:max-w-none mb-8 md:mb-0">
              ...
              <div className="bg-white p-6 sm:p-8 md:p-10 rounded-2xl shadow-xl md:shadow-2xl border border-gray-100 w-full text-left">
                <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 text-textmain">Operational Core</h3>
                ...
                <div className="mt-8 md:mt-10 flex justify-center md:justify-start">
                  ...
                  <button onClick={() => openModal("History PDF")} className="btn-primary">
      ...
      <section className="section-padding bg-textmain text-white px-4 sm:px-6">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            ...
            <p className="text-muted !text-gray-300 text-sm md:text-base px-2 leading-relaxed">Consistency and scale are the hallmarks of our journey.</p>
          </div>
      ...
      <section className="section-padding bg-gray-50 px-4 sm:px-6">
        <div className="container-custom text-center mb-12 md:mb-16">
          ...
          <p className="text-muted text-sm md:text-base px-2 leading-relaxed">A comprehensive tech stack to solve every business challenge.</p>
        </div>
        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-10 md:mb-12 gap-6 text-center md:text-left">
            <div className="max-w-xl w-full">
              <h2 className="heading-xl md:text-left !mb-2 md:!mb-4">Global Reach</h2>
              <p className="text-brandGreen font-medium text-sm md:text-base leading-relaxed">Our distributed model allows us to leverage world-class talent and provide follow-the-sun support.</p>
            </div>
            <div className="text-gray-400 text-xs md:text-sm font-mono tracking-tighter hidden md:block">/ OUR GEOGRAPHY</div>
          </div>
              ...
              <div className="relative order-1 lg:order-2 w-full aspect-[4/3] md:aspect-auto md:min-h-[450px] overflow-hidden rounded-2xl md:rounded-3xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-4 w-full">
                  <div className="bg-brandOrange text-white p-5 md:p-8 rounded-2xl shadow-2xl md:-rotate-3 text-center w-full max-w-[95%] sm:max-w-[85%]">
                    <p className="text-base sm:text-xl md:text-2xl font-black italic leading-tight">"Great engineering is invisible."</p>
                    <span className="text-[10px] md:text-xs mt-3 block opacity-90 uppercase tracking-wider">— Operational Motto</span>
                  </div>
                </div>
              </div>
      ...
      <section className="section-padding bg-white px-4 sm:px-6">
        <div className="container-custom text-center">
          ...
          <p className="text-muted mb-12 md:mb-16 px-2 text-sm md:text-base leading-relaxed">We build relationships that last as long as the code we write.</p>
      ...
      <section className="section-padding bg-textmain text-white relative px-4 sm:px-6">
        ...
        <div className="container-custom flex flex-col items-center text-center relative z-10 py-8 md:py-12 w-full">
          <h2 className="heading-xl !text-white !mb-6 md:!mb-8">Partner with the <br />Future of Engineering.</h2>
          <p className="text-muted !text-gray-400 mb-10 md:mb-12 max-w-2xl mx-auto text-sm md:text-base px-2 leading-relaxed">Let's discuss how our overview matches your specific business goals.</p>
