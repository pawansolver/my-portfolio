      ...
      <section className="relative h-[90vh] flex items-center justify-center text-white">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl container-custom">
          ...
          >
            ...
            <button onClick={() => openModal("Expert Inquiry")} className="btn-secondary !border-white !text-white hover:!bg-white hover:!text-black">
              Talk to Expert
            </button>
          </motion.div>
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="heading-xl !text-left !mb-6">The Cost of <br />Process Stagnation</h2>
            ...
            <div className="relative group">
              ...
              <div className="bg-white p-10 rounded-2xl shadow-2xl border border-gray-100">
                <h3 className="text-2xl font-bold mb-6">Our Core Methodology</h3>
      ...
      <section className="section-padding bg-textmain text-white">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-400">Our results are audited, data-backed, and directly linked to your EBITDA growth.</p>
          </div>
          ...
          <div className="bg-white rounded-[3rem] p-8 md:p-16 shadow-inner border border-gray-100">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <h2 className="text-3xl md:text-4xl font-bold text-textmain leading-tight">Our Core Philosophy: <br /><span className="text-brandOrange">The 5 Lean Pillars</span></h2>
                <div className="text-gray-400 italic text-sm">

[Image of the five principles of lean]
</div>
                <div className="space-y-6">
                  {[
              ...
              <div className="relative aspect-square md:aspect-auto h-full min-h-[400px]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                   <div className="bg-brandOrange text-white p-6 rounded-2xl shadow-2xl rotate-3">
                      <p className="text-2xl font-black italic">"Quality means doing it right when no one is looking."</p>
                      <span className="text-xs mt-2 block opacity-80">— Henry Ford</span>
                   </div>
                </div>
              </div>
            </div>
