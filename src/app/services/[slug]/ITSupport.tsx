      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="heading-xl !text-left !mb-6">The Hidden Cost <br />of Downtime</h2>
            ...
            <div className="relative group">
              ...
              <div className="bg-white p-10 rounded-2xl shadow-2xl border border-gray-100">
                <h3 className="text-2xl font-bold mb-6">Our Support Framework</h3>
...
[Image of IT Support Lifecycle diagram]
                ...
                <button onClick={() => openModal("Service Catalog")} className="mt-10 text-brandOrange font-bold flex items-center gap-2 hover:gap-4 transition-all">
      ...
      <section className="section-padding bg-textmain text-white">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Support Intelligence</h2>
            <p className="text-gray-400">Our performance is measured by your uptime and business continuity.</p>
          </div>
        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-xl">
              <h2 className="heading-xl !text-left !mb-4">Industry Verticals</h2>
            ...
            <div className="text-gray-400 text-sm font-mono tracking-tighter">/ AREA OF SUPPORT</div>
          </div>
          ...
          <div className="bg-white rounded-[3rem] p-8 md:p-16 shadow-inner border border-gray-100">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <h2 className="text-3xl md:text-4xl font-bold text-textmain leading-tight">Our Onboarding: <br /><span className="text-brandOrange">The 4-Step Journey</span></h2>
                <div className="space-y-6">
                  {[
              ...
              <div className="relative aspect-square md:aspect-auto h-full min-h-[400px]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                   <div className="bg-brandOrange text-white p-6 rounded-2xl shadow-2xl -rotate-3">
                      <p className="text-2xl font-black italic">"Technology should work for people, not the other way around."</p>
                      <span className="text-xs mt-2 block opacity-80">— IT Excellence Principle</span>
                   </div>
                </div>
              </div>
            </div>
      ...
      {/* --- 7. DATA PROTECTION (Risk Mitigation) --- */}
      <section className="section-padding bg-white">
      ...
      <section className="section-padding bg-textmain text-white relative">
        ...
        <div className="container-custom text-center relative z-10">
          ...
          <p className="text-muted !text-gray-400 mb-12">Every tech headache is a distraction from your mission. Partner with a team that treats your uptime as our top priority.</p>
