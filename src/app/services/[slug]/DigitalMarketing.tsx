      ...
      <section className="relative h-[90vh] flex items-center justify-center text-white">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl container-custom">
          ...
          >
            ...
            <button onClick={() => openModal("Digital Marketing Audit")} className="btn-secondary !border-white !text-white hover:!bg-white hover:!text-black">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="heading-xl !text-left !mb-6">The Cost of <br />Invisible Brands</h2>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    <div className="mt-1"><TrendingUp className="text-brandOrange w-6 h-6" /></div>
                    <div>
            ...
            <div className="relative group">
              ...
              <div className="bg-white p-10 rounded-2xl shadow-2xl border border-gray-100">
                <h3 className="text-2xl font-bold mb-6">Execution Framework</h3>
...
[Image of Growth Cycle diagram]
                ...
                <button onClick={() => openModal("Digital Marketing Audit")} className="mt-10 text-brandOrange font-bold flex items-center gap-2 hover:gap-4 transition-all">
      ...
      <section className="section-padding bg-textmain text-white">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-400">Our ROI results are data-backed and directly linked to your business scaling.</p>
          </div>
        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-xl">
              <h2 className="heading-xl !text-left !mb-4">Expertise Sectors</h2>
      ...
      {/* --- 6. PHILOSOPHY SECTION (5 Marketing Pillars) --- */}
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="bg-white rounded-[3rem] p-8 md:p-16 shadow-inner border border-gray-100">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <h2 className="text-3xl md:text-4xl font-bold text-textmain leading-tight">Our Core Philosophy: <br /><span className="text-brandOrange">The 5 Growth Pillars</span></h2>
              ...
              <div className="relative aspect-square md:aspect-auto h-full min-h-[400px]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                   <div className="bg-brandOrange text-white p-6 rounded-2xl shadow-2xl rotate-3">
                      <p className="text-2xl font-black italic">"Data beats opinions every single time."</p>
                      <span className="text-xs mt-2 block opacity-80">— Growth Rule #1</span>
                   </div>
                </div>
              </div>
            </div>
