      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="heading-xl md:text-left !mb-6">The High Stakes <br />of Health-Tech</h2>
            ...
            <div className="relative group">
              ...
              <div className="bg-white p-6 md:p-10 rounded-2xl shadow-2xl border border-gray-100">
                <h3 className="text-2xl font-bold mb-6 text-center md:text-left">Medical Data Framework</h3>
                ...
                <div className="my-6 text-center text-gray-400 italic">
                  ...
                  [Image of Medical Data Architecture]
                ...
                <div className="flex justify-center md:justify-start">
                  <button onClick={() => openModal("Framework")} className="btn-primary mt-10 flex items-center gap-2">
      ...
      <section className="section-padding bg-textmain text-white">
        <div className="container-custom text-center">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted !text-gray-300">Our technology is measured by system resilience and practitioner efficiency.</p>
          </div>
        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-12 gap-6 text-center md:text-left">
            <div className="max-w-xl">
              <h2 className="heading-xl md:text-left !mb-4">Healthcare Domains</h2>
            ...
            <div className="text-gray-400 text-sm font-mono tracking-tighter hidden md:block">/ DOMAIN EXPERTISE</div>
          </div>
              ...
              <div className="relative w-full aspect-square md:aspect-auto h-full min-h-[300px] md:min-h-[400px] overflow-hidden rounded-3xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-4">
                  <div className="bg-brandOrange text-white p-6 md:p-8 rounded-2xl shadow-2xl rotate-0 md:-rotate-3 text-center w-full max-w-[90%] md:max-w-[85%]">
                    <p className="text-xl md:text-2xl font-black italic leading-tight">"The best technology is invisible to the patient."</p>
                    <span className="text-xs md:text-sm mt-3 block opacity-80">— Care Excellence Principle</span>
                  </div>
                </div>
              </div>
