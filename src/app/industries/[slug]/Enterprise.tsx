    ...
    <div className="bg-white text-textmain overflow-hidden font-sans">
      ...
      <section className="relative h-[90vh] flex items-center justify-center text-white">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl container-custom">
          ...
          >
            Mission-Critical Enterprise Tech
          </motion.span>
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <button onClick={() => openModal("Consult Architect")} className="btn-secondary !border-white !text-white hover:!bg-white hover:!text-black">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="heading-xl !text-left !mb-6">The Weight of <br />Legacy Architecture</h2>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    <div className="mt-1"><Layers className="text-brandOrange w-6 h-6" /></div>
                    <div>
            ...
            <div className="relative group">
              ...
              <div className="bg-white p-10 rounded-2xl shadow-2xl border border-gray-100">
                <h3 className="text-2xl font-bold mb-6">Connected Enterprise</h3>
                ...
                <button onClick={() => openModal("Modernization Roadmap")} className="mt-10 text-brandOrange font-bold flex items-center gap-2 hover:gap-4 transition-all">
      ...
      <section className="section-padding bg-textmain text-white">
        <div className="container-custom text-center">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Enterprise Benchmarks</h2>
            <p className="text-gray-400">We optimize for high availability, security, and long-term ROI.</p>
          </div>
        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-xl">
              <h2 className="heading-xl !text-left !mb-4">Enterprise Focus</h2>
            ...
            <div className="text-gray-400 text-sm font-mono tracking-tighter">/ CORPORATE REACH</div>
          </div>
          ...
          <div className="bg-white rounded-[3rem] p-8 md:p-16 shadow-inner border border-gray-100">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <h2 className="text-3xl md:text-4xl font-bold text-textmain leading-tight">Our Philosophy: <br /><span className="text-brandOrange">Systemic Agility</span></h2>
              ...
              <div className="relative aspect-square md:aspect-auto h-full min-h-[400px]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                   <div className="bg-brandOrange text-white p-6 rounded-2xl shadow-2xl -rotate-3 text-center">
                      <p className="text-2xl font-black italic">"Agility is the only competitive advantage."</p>
                      <span className="text-xs mt-2 block opacity-80">— Enterprise Excellence Motto</span>
                   </div>
                </div>
              </div>
            </div>
      ...
      <section className="section-padding bg-textmain text-white relative">
        ...
        <div className="container-custom text-center relative z-10">
          ...
          <p className="text-muted !text-gray-400 mb-12">Partner with enterprise architects who understand the complexities of global corporate scaling.</p>
