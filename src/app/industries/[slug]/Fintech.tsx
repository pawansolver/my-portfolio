...
export default function FintechPage() {
  ...
  return (
    <div className="bg-white text-textmain overflow-hidden font-sans">
      ...
      {/* --- 1. HERO SECTION (Mirror: Lean/Healthcare) --- */}
      <section className="relative h-[90vh] flex items-center justify-center text-white">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl container-custom">
          ...
          >
            <button onClick={() => openModal("Fintech Audit")} className="btn-primary">
              Get Security Audit
            </button>
            <button onClick={() => openModal("Fintech Consultation")} className="btn-secondary !border-white !text-white hover:!bg-white hover:!text-black">
      ...
      {/* --- 2. BUSINESS CHALLENGES (Mirror: Lean/Healthcare) --- */}
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="heading-xl !text-left !mb-6">The High Stakes <br />of Digital Money</h2>
            ...
            <div className="relative group">
              ...
              <div className="bg-white p-10 rounded-2xl shadow-2xl border border-gray-100">
                <h3 className="text-2xl font-bold mb-6">Secure Transaction Core</h3>
...
[Image of secure payment processing architecture]
                ...
                <button onClick={() => openModal("Compliance Framework")} className="mt-10 text-brandOrange font-bold flex items-center gap-2 hover:gap-4 transition-all">
      ...
      {/* --- 3. IMPACT STATS (Mirror: Lean/Healthcare) --- */}
      <section className="section-padding bg-textmain text-white">
        <div className="container-custom text-center">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Financial Performance</h2>
            <p className="text-gray-400">We optimize for speed, security, and zero-error processing.</p>
          </div>
      ...
      {/* --- 4. SERVICES (Flip Cards - Mirror: Lean/Healthcare) --- */}
      ...
      {/* --- 5. SECTOR SPECIALIZATION (Mirror: Lean/Healthcare) --- */}
      <section className="section-padding bg-white border-t border-gray-100">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-xl">
              <h2 className="heading-xl !text-left !mb-4">Fintech Domains</h2>
      ...
      {/* --- 6. PHILOSOPHY SECTION (Mirror: Lean/Healthcare) --- */}
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="bg-white rounded-[3rem] p-8 md:p-16 shadow-inner border border-gray-100">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <h2 className="text-3xl md:text-4xl font-bold text-textmain leading-tight">Our Philosophy: <br /><span className="text-brandOrange">Immutable Trust</span></h2>
              ...
              <div className="relative aspect-square md:aspect-auto h-full min-h-[400px]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                   <div className="bg-brandOrange text-white p-6 rounded-2xl shadow-2xl rotate-3 text-center">
                      <p className="text-2xl font-black italic">"In code we trust, but security we verify."</p>
                      <span className="text-xs mt-2 block opacity-80">— Fintech Engineering Motto</span>
                   </div>
                </div>
              </div>
            </div>
      ...
      {/* --- 7. RISK MITIGATION (Mirror: Lean/Healthcare) --- */}
      <section className="section-padding bg-white">
        <div className="container-custom text-center">
      ...
      {/* --- 8. FINAL CTA (Mirror: Lean/Healthcare) --- */}
      <section className="section-padding bg-textmain text-white relative">
        ...
        <div className="container-custom text-center relative z-10">
          ...
          <p className="text-muted !text-gray-400 mb-12">Don't settle for legacy limitations. Leverage our Fintech engineering expertise to scale your vision securely.</p>

          <div className="flex justify-center items-center gap-4 flex-col sm:flex-row">
            <button onClick={() => openModal("Fintech Strategy Call")} className="btn-primary">
              Launch Your Project
            </button>
          </div>
        </div>
