        ...
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="w-full md:w-[52%] bg-white/60 p-6 md:p-8 relative flex flex-col justify-center">
              ...
              <form className="space-y-3.5" onSubmit={(e) => { e.preventDefault(); console.log("Source:", sourcePage); }}>
                <input type="hidden" name="source_page" value={sourcePage} />

                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">Name</label>
                    <input type="text" className="w-full bg-white border border-slate-100 rounded-xl px-3.5 py-2.5 text-[12px] font-medium outline-none focus:border-orange-300 transition-all shadow-sm" placeholder="Full Name" required />
                  </div>
                  <div className="space-y-1">
                    <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">Email</label>
                    <input type="email" className="w-full bg-white border border-slate-100 rounded-xl px-3.5 py-2.5 text-[12px] font-medium outline-none focus:border-orange-300 transition-all shadow-sm" placeholder="Work Email" required />
                  </div>
                </div>
                ...
                <div className="space-y-1 relative" ref={dropdownRef}>
                  ...
                  <div className="flex bg-white border border-slate-100 rounded-xl overflow-hidden shadow-sm focus-within:border-orange-300 transition-all">
                    ...
                    <input type="tel" className="flex-1 px-3.5 py-2.5 text-[12px] font-medium outline-none bg-transparent" placeholder="Phone number" />
                  </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea rows={1} className="w-full bg-white border border-slate-100 rounded-xl px-3.5 py-2.5 text-[12px] font-medium outline-none focus:border-orange-300 transition-all shadow-sm resize-none" placeholder="Project details..." />
                </div>

                <button className="w-full bg-orange-500 hover:bg-orange-600 text-white py-4 rounded-xl font-bold text-[12px] shadow-[0_10px_20px_rgba(249,115,22,0.15)] transition-all active:scale-[0.98] mt-1 tracking-wide uppercase">
                  Submit And Get Reply
                </button>
              </form>
            </div>
          </motion.div>
