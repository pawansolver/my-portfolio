            ...
            <AnimatePresence>
                {isHovered && (
                    ...
                    >
                        ...
                        {/* 🔥 FIX: Changed button background color to a grey theme */}
                        <button
                            onClick={() => router.push('/blog')}
                            className="bg-slate-200 text-slate-800 text-[10px] font-bold tracking-widest uppercase py-3 px-6 rounded-full w-full text-center transition-all hover:bg-slate-300 hover:text-slate-900 hover:scale-105"
                        >
                            Read Full Article
                        </button>
                    </motion.div>
        ...
        <section className="py-8 md:py-12 bg-slate-50 border-b border-slate-200 border-t border-gray-100 px-4 sm:px-6">
            <div className="container-custom relative z-10">
                ...
                <div className="flex justify-center">
                    {/* 🔥 FIX: Defined grey button styling here to maintain visibility and theme */}
                    <button
                        onClick={() => router.push('/blog')}
                        className="bg-slate-200 text-slate-800 font-bold text-sm px-10 py-3.5 rounded-full transition-all hover:bg-slate-300 hover:text-slate-900"
                    >
                        View All Articles
                    </button>
                </div>
