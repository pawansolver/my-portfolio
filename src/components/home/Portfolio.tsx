...
const projects = [
  { id: 1, title: 'NeuralPredict Health AI', category: 'AI Solutions', img: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=800', desc: 'Real-time patient diagnostics using Deep Learning and Neural Networks.' },
  { id: 2, title: 'Nighwan Cloud Core', category: 'Cloud Tech', img: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=800', desc: 'Auto-scaling serverless infrastructure for global enterprise apps.' },
  { id: 3, title: 'SecuVault Enterprise', category: 'Cyber Security', img: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=800', desc: 'Zero-trust security layer with multi-factor biometric encryption.' },
  { id: 4, title: 'AlgoTrade Pro', category: 'Fintech', img: 'https://images.unsplash.com/photo-1611974714139-eddd8103448d?q=80&w=800', desc: 'High-frequency trading bot with real-time AI signal analysis.' },
  { id: 5, title: 'VisionAI Surveillance', category: 'AI Solutions', img: 'https://images.unsplash.com/photo-1507146153580-69a1fe6d8aa1?q=80&w=800', desc: 'Smart object detection and behavioral analysis for retail.' },
  { id: 6, title: 'N-Node Blockchain', category: 'Fintech', img: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?q=80&w=800', desc: 'Decentralized ledger for secure global supply chain tracking.' },
];
